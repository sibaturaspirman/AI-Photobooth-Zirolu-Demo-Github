...
export default function Result() {
    ...
    const [counterKolase, setCounterKolase] = useState(null);
    ...
    useEffect(() => {
        ...
        if (typeof localStorage !== 'undefined') {
            ...
            const item4 = localStorage.getItem('frameBase64')
            const item5 = localStorage.getItem('counterKolase')
            setImageResultAI(item2)
            setImageResultAI2(item4)
            setFormasiFix(item3)
            setLinkQR(item)
            setCounterKolase(item5)
        }
        ...
        //     }
        // }
    }, [imageResultAI, imageResultAI2, counterKolase, linkQR, formasiFix, countdownStart, maxDuration])
                ...
                <div className='relative w-full mt-0 mb-2 mx-auto flex justify-center items-center'>
                    <div className='relative z-10 w-[80%] border-[6px] lg:border-[20px]'>
                        <div className={`relative w-full mx-auto flex`} id='capture' ref={(el) => (componentRef = el)}>
                            ...
                            <Image src={imageResultAI2} width={1000} height={1000} alt='marker' className='absolute block left-0 right-0 top-0 mx-auto w-full pointer-events-none z-10'></Image>
                        </div>
                    </div>
