...
export default function Cam() {
    ...
    return (
        <main className="flex fixed h-full w-full bg-cv-page2 overflow-auto flex-col items-center justify-center pt-2 pb-5 px-5 lg:pt-12 lg:px-20" onContextMenu={(e)=> e.preventDefault()}>
            ...
            <a href='/capture-vibe' className='relative w-[80%] mx-auto flex justify-center items-center'>
            ...
            {!enabled && 
                <div className={`relative w-full flex justify-center items-center mt-8 ${capturedAwal ? 'opacity-0 pointer-events-none' : ''}`}>
                    <button className="relative mx-auto flex  w-[60%] justify-center items-center" onClick={captureVideo}>
                        <Image src='/amild/cv/ambilfoto.png' width={864} height={210} alt='Zirolu' className='w-full' priority />
                    </button>
                </div>
            }
