...
export default function Register() {
    ...
    const generateAI = () => {
        ...
        if(character == 'cowok'){
            ...
            urlGambar = 'https://ai.zirolu.id/nextfest/style/m-'+randomGambar+'.jpeg';
            ...
            setTimeout(() => {
                router.push('/nextfest/cadangan2/cam');
            }, 100);
        }else if(character == 'cewek'){
            let randomGambar = getRandomInt(1,3);
            urlGambar = 'https://ai.zirolu.id/nextfest/style/f-'+randomGambar+'.jpg';
            ...
            setTimeout(() => {
                router.push('/nextfest/cadangan2/cam/camband');
            }, 100);
