...
export default function Cam() {
    ...
    const generateImageSwapCadangan = async () => {
        ...
        try {
            ...
            if(setPrint == 'false'){
                setTimeout(() => {
                    router.push('/nextfest/cadangan/result2');
                }, 500);
            }else{
                setTimeout(() => {
                    router.push('/nextfest/cadangan/result');
                }, 500);
            }
    ...
    const generateImageSwap2 = async () => {
        ...
        try {
            ...
            if(setPrint == 'false'){
                setTimeout(() => {
                    router.push('/nextfest/cadangan2/result2');
                }, 500);
            }else{
                setTimeout(() => {
                    router.push('/nextfest/cadangan2/result');
                }, 500);
            }
