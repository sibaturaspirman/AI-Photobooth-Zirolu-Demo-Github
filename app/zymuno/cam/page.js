...
export default function Cam() {
    ...
    return (
        <main className="flex fixed h-full w-full bg-zymuno overflow-auto flex-col items-center justify-center pt-2 pb-5 px-5 lg:pt-12 lg:px-20" onContextMenu={(e)=> e.preventDefault()}>
            ...
            <h1 className={`text-center text-4xl font-bold mt-5 mb-6 ${poppins.className}`}>Take Photo : Child</h1>
            ...
            <div className={`relative w-full flex flex-col justify-center items-center mt-2 mb-3 lg:mt-8 lg:mb-10 ${numProses1 ? 'opacity-0 pointer-events-none' : ''}`}>
                ...
                <div className='relative w-[70%]'>
                    ...
                    {!enabled && 
                    <div className='w-[92%] mx-auto absolute left-0 right-0 bottom-0 z-10'>
            ...
            {!enabled && 
                <div className={`relative w-full flex justify-center items-center mt-8 ${capturedAwal ? 'opacity-0 pointer-events-none' : ''}`}>
                    <button className="relative mx-auto flex  w-[75%] justify-center items-center" onClick={captureVideo}>
                        <Image src='/zymuno/btn-capture.png' width={410} height={96} alt='Zirolu' className='w-full' priority />
                    </button>
                </div>
            }
            ...
            <div className={`relative w-full ${!enabled ? 'hidden' : ''}`}>
                <div className="relative w-[75%] mx-auto flex justify-center items-center flex-col mt-0">
                    ...
                    <Link href='/zymuno/cam2' className="w-full relative mx-auto flex justify-center items-center">
                        <Image src='/zymuno/btn-next.png' width={410} height={96} alt='Zirolu' className='w-full' priority />
                    </Link>
