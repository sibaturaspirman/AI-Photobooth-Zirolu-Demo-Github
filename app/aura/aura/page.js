...
export default function Register() {
    ...
    return (
        <main className="flex fixed h-full w-full bg-a overflow-auto flex-col items-center justify-center pt-2 pb-5 px-5 lg:pt-12" onContextMenu={(e)=> e.preventDefault()}>
