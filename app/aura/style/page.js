...
export default function Register() {
    ...
    return (
        <main className="flex fixed h-full w-full bg-a overflow-auto flex-col items-center justify-center pt-2 pb-5 px-5 lg:pt-12 lg:px-20" onContextMenu={(e)=> e.preventDefault()}>
            ...
            <Image src='/identify-a.png' width={720} height={260} alt='Zirolu' className='w-full' priority />
            </div>
            {/* PILIH STYLE */}
            <div className={`relative w-[70%] mx-auto mt-0`}>
                <div className='relative mt-0 w-full'>
                    <div className='relative w-full'>
                        ...
                        {/* {character == 'cewek' && */}
                        <div className={`mt-0 relative w-[80%] mx-auto p-5  ${character == 'cewek' ? `` : 'opacity-0 pointer-events-none'}`}>
                ...
                {/* {character && */}
                    <div className={`relative w-full flex justify-center items-center mt-[1rem] z-20 ${character ? `` : 'opacity-0 pointer-events-none'}`}>
