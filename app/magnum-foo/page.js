...
export default function GreendayMagnumHome() {
  return (
    <Link href='/magnum-foo/frame' className="flex fixed h-full w-full overflow-auto flex-col items-center justify-center pt-2 pb-5 px-5 lg:pt-0 lg:px-20 mt-0">
      ...
      <div className="relative w-full flex justify-center items-center flex-col lg:top-[-6rem]">
        <div className='animate-upDown relative w-[35%] lg:w-[40%] mx-auto flex justify-center items-center pointer-events-none'>
          <Image src='/magnum/foo-front.png' width={442} height={1405} alt='Zirolu' className='w-full' priority />
        </div>
      </div>
