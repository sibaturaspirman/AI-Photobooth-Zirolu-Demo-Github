        ...
        <div className="fixed top-0 left-0 w-full h-full bg-iqos-border pointer-events-none z-50"></div>
            ...
            {generateQR && 
                <div className='absolute top-[2rem] left-0 right-0 bottom-0 flex items-center justify-center flex-col z-40 bg-black bg-opacity-0'>
                    <div className={`relative w-[60%] mx-auto mb-10  mt-[-25rem]`}>
                    ...
                    <Link href='/meta4' className="relative w-[80%] mx-auto pt-10 flex justify-center items-center">
                    ...
                    trigger={() => 
                        <div className={`w-full mt-5`}>
                            <div className="relative w-[80%] mx-auto flex justify-center items-center flex-col">
                                <div className="w-full relative mx-auto flex justify-center items-center">
                                <Image src='/meta/btn-collect2.png' width={864} height={210} alt='Zirolu' className='w-full' priority />
                                </div>
                            </div>
                        </div>
                    }
