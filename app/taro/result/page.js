...
export default function Result() {
    ...
    const [imageResultAICharacter, setImageResultAICharacter] = useState(null);
    ...
    useEffect(() => {
        ...
        if (typeof localStorage !== 'undefined') {
            ...
            const item3 = localStorage.getItem('characterTaro')
            // const item2 = localStorage.getItem('faceURLResult')
            setImageResultAI(item)
            setImageResultAI2(item2)
            setImageResultAICharacter(item3)
            // setLinkQR(item2)
        }
        ...
        //     phone: item3,
        //   }));
    }, [imageResultAI, imageResultAI2, imageResultAICharacter, linkQR])
            ...
            <div className={generateQR ? `opacity-0 pointer-events-none` : ''}>
                ...
                <div className='relative w-[100%] mt-4 mx-auto flex justify-center items-center  border-2 border-[#ffffff] rounded-sm' onClick={downloadImageAI}>
                    <div className='relative' id='capture'>
                        ...
                        <div className={imageResultAICharacter == 'https://ai.zirolu.id/taro/taro-1-swap.jpeg' ?`hidden` : 'flex justify-center items-center'}>
                        <Image src={imageResultAI}  width={750} height={1334} alt='Zirolu' className='relative block w-full'></Image>
                        </div>

                        <div className={imageResultAICharacter != 'https://ai.zirolu.id/taro/taro-1-swap.jpeg' ?`hidden` : 'flex justify-center items-center'}>
                        <Image src={imageResultAI}  width={375} height={1334} alt='Zirolu' className='relative block w-1/2'></Image>
                        <Image src={imageResultAI2}  width={375} height={1334} alt='Zirolu' className='relative block w-1/2'></Image>
                        </div>
                ...
                <div className={`relative w-full ${loadingDownload ? 'hiddenx' : ''}`}>
                    ...
                    <div className='w-full'>
                        <div className="relative w-[80%] mx-auto flex justify-center items-center flex-col">
                            <Link href='/taro/generate' className="relative mx-auto flex justify-center items-center">
