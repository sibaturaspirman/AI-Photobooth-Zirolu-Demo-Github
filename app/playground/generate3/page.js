...
let URL_RESULT = '', URL_RESULT_2 = '', URL_RESULT_3 = '', URL_RESULT_4 = '', URL_RESULT_5 = ''
let FACE_URL_RESULT = ''
let numberProses = 0, randomSeed = 0
// let fixSeed = ''
    ...
    //   console.log(url)
      try {
        ...
        if(numberProses == 16){
            ...
            setTimeout(() => {
                router.push('/playground/result3');
            }, 500);
        }else{
            if (typeof localStorage !== 'undefined') {
                localStorage.setItem("generateURLResult"+numberProses, URL_RESULT)
        ...
        //     if (typeof localStorage !== 'undefined') {
        //         localStorage.setItem("generateURLResult"+numberProses, URL_RESULT)
        //         localStorage.setItem("generateBase64Result"+numberProses, dataUrl)
        //         localStorage.setItem("generateSeedResult"+numberProses, randomSeed)
        //     }
