...
export default function Cam() {
    ...
    return (
        <main className="flex fixed h-full w-full bg-asdp2 overflow-auto flex-col items-center justify-center pt-2 pb-5 px-5 lg:pt-12 lg:px-20" onContextMenu={(e)=> e.preventDefault()}>
            ...
            <Image src='/asdp/take.png' width={616} height={118} alt='Zirolu' className='w-full' priority />
            </div>
            
            <div className={`fixed top-0 left-0 w-full h-full bg-asdp2 flex items-center justify-center z-50 ${error ? 'hidden' : ''}`}>
            <a href='/asdp/cam' className='relative w-[80%] mx-auto flex justify-center items-center'>
            ...
            {!enabled && 
                <p className='block text-center text-5xl mt-1 mb-3 lg:mt-4 text-black'>*Foto hanya sendiri <br></br> *Ikuti garis pose dan tidak terlalu zoom</p> 
            }
            {!enabled && 
                <div className={`relative w-full flex justify-center items-center mt-8 ${capturedAwal ? 'opacity-0 pointer-events-none' : ''}`}>
                    <button className="relative mx-auto flex  w-[80%] justify-center items-center" onClick={captureVideo}>
                        <Image src='/asdp/btn-capture.png' width={864} height={210} alt='Zirolu' className='w-full' priority />
                    </button>
                </div>
            }
            ...
            <div className={`relative w-full ${!enabled ? 'hidden' : ''}`}>
                <div className="relative w-[80%] mx-auto flex justify-center items-center flex-col mt-0">
                    <button className="w-full relative mx-auto flex justify-center items-center" onClick={generateAI}>
                        <Image src='/asdp/btn-generate.png' width={864} height={210} alt='Zirolu' className='w-full' priority />
                    </button>
                    <button className="relative w-full mx-auto flex justify-center items-center mt-10" onClick={retake}>
                        <Image src='/asdp/btn-retake.png' width={864} height={210} alt='Zirolu' className='w-full' priority />
                    </button>
                </div>
            </div></div>
        </main>
