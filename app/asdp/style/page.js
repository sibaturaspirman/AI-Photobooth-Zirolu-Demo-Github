...
export default function Register() {
    ...
    const generateAI = () => {
        ...
        if(character == 'cowok'){
            ...
            urlGambar = 'https://ai.zirolu.id/asdp/m-'+randomGambar+'.jpg';
            ...
            if(styleFemale == 'normal'){
                let randomGambar = getRandomInt(1,5);
                // let randomGambar = 'fix';
                urlGambar = 'https://ai.zirolu.id/asdp/f-'+randomGambar+'.jpg';
                ...
                let randomGambar = getRandomInt(1,5);
                // let randomGambar = 'fix';
                urlGambar = 'https://ai.zirolu.id/asdp/h-'+randomGambar+'.jpg';
    ...
    return (
        <main className="flex fixed h-full w-full bg-asdp2 overflow-auto flex-col items-center justify-center pt-2 pb-5 px-5 lg:pt-12 lg:px-20" onContextMenu={(e)=> e.preventDefault()}>
            ...
            <Image src='/asdp/identify.png' width={720} height={157} alt='Zirolu' className='w-full' priority />
            </div>
            {/* PILIH STYLE */}
                ...
                {/* {character && */}
                    <div className={`relative w-full flex justify-center items-center mt-[22rem] z-20 ${character ? `` : 'opacity-0 pointer-events-none'}`}>
                        <button className="relative mx-auto w-[100%] flex justify-center items-center" onClick={generateAI}>
                            <Image src='/asdp/btn-continue.png' width={864} height={210} alt='Zirolu' className='w-full' priority />
                        </button>
                    </div>
                {/* } */}
            </div>
