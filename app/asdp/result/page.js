...
export default function Result() {
    ...
    return (
        <main className="flex fixed h-full w-full bg-asdp2 overflow-auto flex-col items-center pt-2 pb-5 px-5 lg:pt-12 lg:px-20" onContextMenu={(e)=> e.preventDefault()}>
        {/* <div className="fixed top-0 left-0 w-full h-full bg-iqos-border pointer-events-none z-50"></div> */}
            ...
            {generateQR && 
                <div className='absolute top-[2rem] left-0 right-0 bottom-0 flex items-center justify-center flex-col z-40 bg-black bg-opacity-0'>
                    <div className={`relative w-[60%] mx-auto mb-10`}>
                        <Image src='/asdp/scan.png' width={580} height={213} alt='Zirolu' className='w-full' priority />
                    </div>
                    ...
                    <Link href='/asdp' className='text-center font-semibold text-base lg:text-7xl  pt-20 p-40 py-96 text-black w-full'>Tap here to close</Link>
                </div>
            }
            {/* QR */}
            ...
            <div className={generateQR ? `opacity-0 pointer-events-none` : ''}>
                ...
                <div className={`relative w-full ${loadingDownload ? 'hidden' : ''}`}>
                    ...
                    <div className={`w-full`} onClick={downloadImageAI}>
                        <div className={`w-full mt-10`}>
                            <div className="relative w-[70%] mx-auto flex justify-center items-center flex-col">
                                <div className="w-full relative mx-auto flex justify-center items-center">
                                 <Image src='/asdp/btn-collect.png' width={864} height={210} alt='Zirolu' className='w-full' priority />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='w-full'>
                        <div className="relative w-[70%] mx-auto flex justify-center items-center flex-col mt-5">
                            <Link href='/asdp/style' className="relative w-full mx-auto flex justify-center items-center">
