...
export default function Cam() {
    ...
    return (
        <main className="flex fixed h-full w-full bg-gac-page overflow-auto flex-col justify-center items-center py-5 px-5 lg:py-16 lg:px-20" onContextMenu={(e)=> e.preventDefault()}>
            <div className='fixed w-full mx-auto flex justify-center items-center pointer-events-none top-[4rem] left-0 right-0 mx-auto'>
            <Image src='/gac/title-take.png' width={834} height={156} alt='Zirolu' className='w-full' priority />
            </div>
            <div className="relative w-full flex flex-col justify-center items-center mt-[9rem] mb-10">
            ...
            {!enabled && 
                <div className="relative left-0 mt-10 w-full flex justify-center items-center flex-col">
                    <button className="relative mx-auto flex w-[100%] justify-center items-center" onClick={captureVideo}>
                        <Image src='/gac/btn-capture.png' width={644} height={120} alt='Zirolu' className='w-full' priority />
                    </button>
                    <Link href='/gac' className="relative w-[100%] mx-auto flex justify-center items-center">
            ...
            <div className={`relative left-0 w-full mt-10 ${!enabled ? 'hidden' : ''}`}>
                <div className="relative w-[100%] mx-auto flex justify-center items-center flex-col">
                    <Link href='/gac/generate' className="w-full relative mx-auto flex justify-center items-center">
                        <Image src='/gac/btn-continue.png' width={644} height={120} alt='Zirolu' className='w-full' priority />
                    </Link>
                    <button className="relative w-full mx-auto flex justify-center items-center pt-2" onClick={retake}>
                        <Image src='/btn-retake.png' width={644} height={120} alt='Zirolu' className='w-full' priority />
                    </button>
                </div>
            </div>
        </main>
