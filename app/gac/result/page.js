        ...
        <main className="flex fixed h-full w-full bg-gac-page overflow-auto flex-col justify-center items-center py-5 px-5 lg:py-16 lg:px-20" onContextMenu={(e)=> e.preventDefault()}>
            ...
            {generateQR && 
                <div className='absolute top-0 left-0 right-0 bottom-0 flex items-center justify-center flex-col z-40 bg-kai3 text-black bg-opacity-0'>
                    ...
                    <Image src='/gac/title-scan.png' width={834} height={234} alt='Zirolu' className='w-full' priority />
                    </div>
                    ...
                    <a href='/gac' className='text-center font-semibold text-7xl text-white w-full mt-2 p-52'>Tap here to close</a>
                    ...
                    <div className={`w-full`}>
                        <div className={`w-full mt-6`}>
                            <div className="relative w-[90%] mx-auto flex justify-center items-center flex-col">
                                ...
                                trigger={() => 
                                    <div className={`w-full`}>
                                        <div className="w-full relative mx-auto flex justify-center items-center">
                                            <Image src='/gac/btn-collect.png' width={644} height={120} alt='Zirolu' className='w-full' priority />
                                        </div>
                                    </div>
                                }
                                ...
                                <Link href='/gac/cam' className="relative w-full mx-auto flex justify-center items-center pt-4">
