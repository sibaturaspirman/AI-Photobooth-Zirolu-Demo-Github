...
export default function IQOSHome() {
  return (
    <Link href='/iqos-prj2/style' className="flex fixed h-full w-full bg-iqos-prj-home overflow-auto flex-col items-center justify-center">
      ...
      {/* <div className="absolute mx-auto bottom-10 lg:bottom-[20rem] w-[80%] ">
        <Link href='/cpl/style' className='relative w-full mx-auto flex justify-center items-center'>
          <Image src='/veev/lenti/btn-continue.png' width={880} height={144} alt='Zirolu' className='w-full' priority />
        </Link>
      </div> */}
    </Link>
  );
