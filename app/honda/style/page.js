...
export default function Register() {
    ...
    return (
        <main className="flex fixed h-full w-full bg-honda overflow-auto flex-col items-center justify-center pt-2 pb-5 px-5 lg:pt-12 lg:px-20" onContextMenu={(e)=> e.preventDefault()}>
            ...
            <Image src='/honda/identify.png' width={967} height={287} alt='Zirolu' className='w-full' priority />
            </div>
            {/* PILIH STYLE */}
                ...
                {/* {character && */}
                    <div className={`relative w-full flex justify-center items-center mt-2 lg:mt-[9rem] z-20 ${character ? `` : 'opacity-0 pointer-events-none'}`}>
                        <button className="relative mx-auto w-[100%] flex justify-center items-center" onClick={generateAI}>
                            <Image src='/honda/btn-continue.png' width={850} height={258} alt='Zirolu' className='w-full' priority />
                        </button>
                    </div>
                {/* } */}
            </div>
