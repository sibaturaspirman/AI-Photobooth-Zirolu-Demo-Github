...
export default function Cam() {
    ...
    return (
        <main className="flex fixed h-full w-full bg-amero overflow-auto flex-col items-center pt-2 pb-5 px-5 lg:pt-12 lg:px-20">
            ...
            {!enabled && 
                <p className='block text-center text-sm lg:text-4xl mt-1 mb-3 lg:mt-4 text-white'>*Foto hanya untuk sendiri <br></br> *Ikuti garis pose dan tidak terlalu zoom</p> 
            }
