    ...
    return (
        <main className="flex fixed h-full w-full bg overflow-auto flex-col items-center justify-top pt-2 pb-5 px-5 lg:pt-12 lg:pb-16 lg:px-13">
            ...
            <div className={generateQR ? `opacity-0 pointer-events-none` : ''}>
                ...
                {imageResultAI && 
                <div className='relative w-[100%] mt-4 mx-auto flex justify-center items-center  border-2 border-[#ffffff] rounded-sm'>
                    <div className='relative' id='capture'>
                        <div className='relative'>
                            <Image src={imageResultAI}  width={384} height={546} alt='Zirolu' className={stateColor == 1 ? `relative block w-full` : 'relative block w-full opacity-0 pointer-events-none'}></Image>
                            <Image src={imageResultAI2}  width={384} height={546} alt='Zirolu' className={stateColor == 2 ? `absolute top-0 left-0 block w-full` : 'absolute top-0 left-0 block w-full opacity-0 pointer-events-none'}></Image>
                            <Image src={imageResultAI3}  width={384} height={546} alt='Zirolu' className={stateColor == 3 ? `absolute top-0 left-0 block w-full` : 'absolute top-0 left-0 block w-full opacity-0 pointer-events-none'}></Image>
                        </div>

                        <div onClick={()=>{setStateColor(1);}}>COLOR 1</div>
                        <div onClick={()=>{setStateColor(2);}}>COLOR 2</div>
                        <div onClick={()=>{setStateColor(3);}}>COLOR 3</div>
                    ...
                    <div id='canvasResult' className='pointer-events-none absolute top-0 left-0 right-0 bottom-0 z-10'></div>
                </div>
                }
                {loadingDownload && 
                ...
                <div className={`relative w-full ${loadingDownload ? 'hiddenx' : ''}`}>
                    ...
                    <div className='w-full'>
                        <div className="relative w-[80%] mx-auto flex justify-center items-center flex-col">
                            <Link href='/moslem/generate' className="relative mx-auto flex justify-center items-center">
