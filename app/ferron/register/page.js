...
import BtnHexagonDexa from "../../components/BtnHexagonDexa";
...
export default function Register() {
    ...
    const handleSubmit = () => {
        ...
        setTimeout(() => {
            router.push('/ferron/how');
        }, 250);
    }
    return (
        <main className="flex fixed h-full w-full bg-dexa overflow-auto flex-col items-center pt-16 pb-5 px-5 lg:pt-12 lg:px-20">
            <TopLogoFerron></TopLogoFerron>
            <h1 className={`text-center text-4xl font-bold mt-5 mb-10 ${poppins.className}`}>REGISTRATION</h1>
