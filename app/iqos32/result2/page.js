    ...
    return (
        ...
        <div className="fixed top-0 left-0 w-full h-full bg-iqos-border pointer-events-none z-50"></div>
            ...
            {generateQR && 
                <div className='absolute top-[-7rem] left-0 right-0 bottom-0 flex items-center justify-center flex-col z-40 bg-black bg-opacity-0'>
                    <div className={`relative w-[60%] mx-auto mb-10`}>
                        <Image src='/iqos/neon/scandownload.png' width={803} height={97} alt='Zirolu' className='w-full' priority />
                    </div>
                    ...
                    <Link href='/iqos32/home' className="w-[70%] relative mx-auto mt-10 flex justify-center items-center">
            ...
            <div className={generateQR ? `opacity-0 pointer-events-none` : ''}>
                ...
                {loadingDownload && 
                    <div className='relative mt-5 lg:mt-2 border-2 text-center bg-[#A91E58] rounded-xl text-[#fff] lg:font-bold p-5 lg:text-5xl w-[80%] lg:w-[80%] mx-auto'>
                ...
                <div className={`relative w-full ${loadingDownload ? 'hidden' : ''}`}>
                    ...
                    <div className={`w-full`} onClick={downloadImageAI}>
                        <div className={`w-full mt-5`}>
                            <div className="relative w-[90%] mx-auto flex justify-center items-center flex-col">
                                <div className="w-full relative mx-auto flex justify-center items-center">
                                <Image src='/iqos/neon/btn-download.png' width={775} height={180} alt='Zirolu' className='w-full' priority />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='w-full'>
                        <div className="relative w-[90%] mx-auto flex justify-center items-center flex-col">
                            <Link href='/iqos32/style' className="relative w-full mx-auto flex justify-center items-center">
                                <Image src='/iqos/neon/btn-retake.png' width={711} height={120} alt='Zirolu' className='w-full' priority />
                            </Link>
                        </div>
                    </div>
                </div>
