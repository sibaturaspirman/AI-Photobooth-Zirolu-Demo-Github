...
export default function Cam() {
    ...
    return (
        <main className="flex fixed h-full w-full bg-iqos-neon overflow-auto flex-col items-center justify-center pt-2 pb-5 px-5 lg:pt-12 lg:px-20" onContextMenu={(e)=> e.preventDefault()}>
            ...
            <div className={`absolute pointer-events-none bottom-[3rem] left-0 right-0 mx-auto w-[35%] ${numProses1 ? 'opacity-0' : ''} ${(getCookie('lokasiIQOS') == 'swill' || getCookie('lokasiIQOS') == 'jackson') ? 'opacity-0' : ''}`}>
            ...
            {/* {(getCookie('lokasiIQOS') == 'swill' || getCookie('lokasiIQOS') == 'jackson') && */}
            <div className={`absolute pointer-events-none top-[3.2rem] left-0 right-0 mx-auto w-[31%] ${numProses1 ? 'opacity-0 pointer-events-none' : ''} ${(getCookie('lokasiIQOS') == 'swill' || getCookie('lokasiIQOS') == 'jackson') ? '' : 'opacity-0'}`}>
                <div className={`relative w-full`}>
