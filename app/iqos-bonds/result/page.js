        ...
        <main className="flex fixed bg-iqos-bonds h-full w-full overflow-auto flex-col items-center justify-center pt-2 pb-5 px-5 lg:pt-12 lg:px-20" onContextMenu={(e)=> e.preventDefault()}>
            ...
            {generateQR && 
                <div className='absolute top-[2rem] left-0 right-0 bottom-0 flex items-center justify-center flex-col z-40 bg-black bg-opacity-0'>
                    ...
                    <Link href='/iqos-bonds' className="relative w-[60%] mx-auto flex justify-center items-center mt-10">
            ...
            <div className={generateQR ? `opacity-0 pointer-events-none` : 'relative w-full flex justify-center items-center flex-col'}>
                ...
                <div className='relative w-full mt-[10rem] mb-2 mx-auto flex justify-center items-center'>
                    <div className='relative z-10 w-[80%] p-5 border-4 border-white rounded-3xl'>
                ...
                <div className={`relative w-full ${loadingDownload ? 'hidden' : ''}`}>
                    ...
                    {/* <div className='flex justify-center items-center mt-10'>
                        ...
                        <div className={`w-full pl-5`} onClick={downloadImageAI}>
                            <div className="w-full relative mx-auto flex justify-center items-center">
