  ...
  return (
    <div className="flex fixed h-full w-full bg-meta overflow-auto flex-col items-center justify-center">
      ...
      <div className="relative w-full">
        <Image src='/meta/preview.png' width={787} height={84} alt='Zirolu' className='w-full' priority />
      </div>
      <div className="relative w-[80%] mb-[11rem]">
        <Link href='meta/style' className='relative w-full mx-auto flex justify-center items-center'>
          <Image src='/meta/btn-continue.png' width={880} height={144} alt='Zirolu' className='w-full' priority />
        </Link>
      </div>
    </div>
  );
