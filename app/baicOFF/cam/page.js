...
export default function Cam() {
    ...
    useEffect(() => {
        ...
        const aiInstance = new PadmaAIClient("https://padmaai.zirolu.id", "app_tXxTmRGXzUwliMw1sMgdFUlDFF2S2IO6", "7e3ba4d5-d87d-4a6d-ad60-43f67c92d4d7");
    ...
    return (
        <main className="flex fixed h-full w-full bg-baic overflow-auto flex-col items-center justify-center pt-2 pb-5 px-5 lg:pt-12 lg:px-20" onContextMenu={(e)=> e.preventDefault()}>
            ...
            <Image src='/baic/take.png' width={801} height={247} alt='Zirolu' className='w-full' priority />
            </div>
            ...
            {numProses1 && 
                <div className='absolute top-0 left-0 right-0 bottom-0 flex items-center justify-center flex-col z-20'>
                    ...
                    <div className="absolute top-[20rem] mx-auto flex  w-[70%] justify-center items-center">
                        <Image src='/baic/preparing.png' width={836} height={217} alt='Zirolu' className='w-full' priority />
                    </div>
                    ...
                    <div className='animate-upDownCepet relative py- px-4 mt-5 lg:mt-10 lg:p-10 lg:text-6xl border-2 text-center bg-black/20 rounded-xl text-[#fff] lg:font-bold'>
            ...
            {!enabled && 
                <div className={`relative w-full flex justify-center items-center mt-8 ${capturedAwal ? 'opacity-0 pointer-events-none' : ''}`}>
                    <button className="relative mx-auto flex  w-[80%] justify-center items-center" onClick={captureVideo}>
                        <Image src='/baic/btn-capture.png' width={864} height={210} alt='Zirolu' className='w-full' priority />
                    </button>
                </div>
            }
            ...
            <div className={`relative w-full ${!enabled ? 'hidden' : ''}`}>
                <div className="relative w-[80%] mx-auto flex justify-center items-center flex-col mt-0">
                    <button className="w-full relative mx-auto flex justify-center items-center" onClick={generateAI}>
                        <Image src='/baic/btn-surprise.png' width={864} height={210} alt='Zirolu' className='w-full' priority />
                    </button>
                    <button className="relative w-full mx-auto flex justify-center items-center mt-8" onClick={retake}>
