...
export default function Voice() {
    ...
    return (
        <main className="flex fixed h-full w-full bg-primaria overflow-auto flex-col items-center pt-2 pb-5 px-5 lg:pt-12 lg:px-20">
            ...
            <h1 className={`text-center text-6xl font-medium leading-snug mt-10 mb-10 ${kanit.className}`}>Ketawain masalah lo sekenceng-kencengnya sampai semangatmu terisi penuh!</h1>
