...
export default function IQOSHome() {
  return (
    <Link href='/purina/purina-studio/cam' className="flex fixed h-full w-full bg-purina-ps overflow-auto flex-col items-center justify-center">
      ...
      <div className="relative w-[80%] mt-[-4rem]">
        <Image src='/purina/pstd-logo.png' width={314} height={503} alt='Zirolu' className='w-full' priority />
      </div>
