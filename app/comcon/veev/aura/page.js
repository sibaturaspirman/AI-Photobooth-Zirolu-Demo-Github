...
export default function Register() {
    ...
    return (
        <main className="flex fixed h-full w-full bg-veev overflow-auto flex-col items-center justify-center pt-2 pb-5 px-5 lg:pt-12" onContextMenu={(e)=> e.preventDefault()}>
            ...
            {/* !PILIH STYLE */}
            <div className={`fixed top-0 bottom-0 left-0 right-0 w-full z-40 flex justify-center items-end bg-black/0 pointer-events-none transition-all ${swipeTrigger ? `opacity-0` : ''}`}>
