...
export default function Register() {
    ...
    return (
        <main className="flex fixed h-full w-full bg-visikom overflow-auto flex-col items-center justify-center pt-2 pb-5 px-5 lg:pt-12 lg:px-20" onContextMenu={(e)=> e.preventDefault()}>
            ...
            <Image src='/comcon/visikom/identify.png' width={784} height={120} alt='Zirolu' className='w-full' priority />
            </div>
            {/* PILIH STYLE */}
                        ...
                        <div className='overflow-hidden w-full mx-auto'>
                            ...
                            <li className='mb-10'>
                                ...
                                <Image
                                    ...
                                    src="/comcon/visikom/gender1.png"
                                    alt="icon"
                                    width={720}
                                    height={176}
                                    priority
                            ...
                            <li className="!mb-0">
                                ...
                                <Image
                                    className="relative h-auto w-full"
                                    src="/comcon/visikom/gender2.png"
                                    alt="icon"
                                    width={720}
                                    height={176}
                                    priority
