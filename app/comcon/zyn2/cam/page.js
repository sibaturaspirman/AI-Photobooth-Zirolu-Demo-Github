...
export default function Cam() {
    ...
    useEffect(() => {
        ...
        const aiInstance = new PadmaAIClient("https://padmaai.zirolu.id", "app_tXxTmRGXzUwliMw1sMgdFUlDFF2S2IO6", "comcon24-zyn-swap");
        ...
        padmaAI.onProgress((progress) => {
          ...
          try {
            ...
            .then(dataUrl => {
                ...
                setTimeout(() => {
                    router.push('/comcon/zyn2/result');
                }, 200);
            })
    ...
    return (
        <main className="flex fixed h-full w-full bg-zyn overflow-auto flex-col items-center justify-center pt-2 pb-5 px-5 lg:pt-12 lg:px-20" onContextMenu={(e)=> e.preventDefault()}>
            ...
            <div className={`fixed top-0 left-0 w-full h-full bg-zyn flex items-center justify-center z-50 ${error ? 'hidden' : ''}`}>
            <a href='/comcon/zyn/cam' className='relative w-[80%] mx-auto flex justify-center items-center'>
            ...
            {!enabled && 
                <div className={`relative w-full flex justify-center items-center mt-8 ${capturedAwal ? 'opacity-0 pointer-events-none' : ''}`}>
                    <button className="relative mx-auto flex  w-[80%] justify-center items-center" onClick={captureVideo}>
                        <Image src='/comcon/zyn/btn-capture.png' width={864} height={210} alt='Zirolu' className='w-full' priority />
                    </button>
                </div>
            }
            ...
            <div className={`relative w-full ${!enabled ? 'hidden' : ''}`}>
                <div className="relative w-[80%] mx-auto flex justify-center items-center flex-col mt-0">
                    <button className="w-full relative mx-auto flex justify-center items-center" onClick={generateAI}>
                        <Image src='/comcon/zyn/btn-surprise.png' width={864} height={210} alt='Zirolu' className='w-full' priority />
                    </button>
