...
export default function Result() {
    ...
    return (
        <main className="flex fixed h-full w-full bg-mlb overflow-auto flex-col items-center pt-2 pb-5 px-5 lg:pt-12 lg:px-20" onContextMenu={(e)=> e.preventDefault()}>
            {/* <div className="fixed top-0 left-0 w-full h-full bg-iqos-border pointer-events-none z-50"></div> */}
            <div className={`relative w-[40%] mx-auto mt-[6rem] mb-10 ${generateQR ? `opacity-0 pointer-events-none` : ''}`}>
            ...
            {generateQR && 
                <div className='absolute top-[2rem] left-0 right-0 bottom-0 flex items-center justify-center flex-col z-40 bg-black bg-opacity-0'>
                    <div className={`relative w-[40%] mx-auto mt-[0] mb-[5rem]`}>
                    <Image src='/comcon/mlb/iam.png' width={584} height={189} alt='Zirolu' className='w-full' priority />
                    </div>
                    <div className={`relative w-[60%] mx-auto mb-10`}>
                        <Image src='/comcon/mlb/scan.png' width={580} height={213} alt='Zirolu' className='w-full' priority />
                    </div>
                        ...
                        <div className={`w-full mt-5`}>
                            <div className="relative w-[60%] mx-auto flex justify-center items-center flex-col">
                                <div className="w-full relative mx-auto flex justify-center items-center">
                                    <Image src='/comcon/mlb/btn-print.png' width={410} height={96} alt='Zirolu' className='w-full' priority />
                                </div>
                            </div>
                        </div>
                    }
                    ...
                    <Link href='/comcon/mlb2' className='text-center font-semibold text-base lg:text-7xl  pt-20 p-40 py-96 text-white w-full'>Tap here to close</Link>
                </div>
            }
            {/* QR */}
            ...
            <div className={generateQR ? `opacity-0 pointer-events-none relative w-full` : 'relative w-full'}>
                ...
                {loadingDownload && 
                    <div className='relative mt-5 lg:mt-2 border-2 text-center bg-[#CC1A24] rounded-xl text-[#fff] lg:font-bold p-5 lg:text-5xl w-[80%] lg:w-[80%] mx-auto'>
                ...
                <div className={`relative w-full ${loadingDownload ? 'hidden' : ''}`}>
                    ...
                    <div className={`w-full`} onClick={downloadImageAI}>
                        <div className={`w-full mt-10`}>
                            <div className="relative w-[70%] mx-auto flex justify-center items-center flex-col">
                                <div className="w-full relative mx-auto flex justify-center items-center">
                                 <Image src='/comcon/mlb/btn-collect.png' width={864} height={210} alt='Zirolu' className='w-full' priority />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='w-full'>
                        <div className="relative w-[70%] mx-auto flex justify-center items-center flex-col">
                            <Link href='/comcon/mlb2/style' className="relative w-full mx-auto flex justify-center items-center">
