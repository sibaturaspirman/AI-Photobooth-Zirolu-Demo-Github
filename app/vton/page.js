...
export default function FaceSwap() {
    ...
    const [desc, setDesc] = useState('Short Sleeve Round Neck');
        ...
        try {
            const result = await fal.subscribe(
                ...
                input: {
                    ...
                    garment_image_url: swapFaceFile,
                    description: desc,
                    seed: seed,
                    num_inference_stepsinteger: step,
                },
        ...
        <main className="flex min-h-screen flex-col items-center justify-top pt-12 px-4 lg:p-20">
            ...
            <div className="relative w-full flex flex-col justify-center items-center mt-4 mb-0">
                <div className='relative w-full lg:w-[80%] mb-6'>
                    <label htmlFor="base" className="text-[#D8BA78] font-bold text-2xl mb-2 block">Base Photo (768x1024px)</label>
                    <div className='relative w-full'>
                        <input
                            type='file'
                            id='base'
                            name='base'
                            className={`w-full border-2 border-[#D8BA78] rounded-sm font-semibold text-2xl outline-none py-2 pr-3 text-white bg-black bg-opacity-[4%]'`}
                            placeholder='Base Photo'
                ...
                <div className='relative w-full lg:w-[80%] mb-6'>
                    <label htmlFor="swap" className="text-[#D8BA78] font-bold text-2xl mb-2 block">Garment/Baju (768x1024px)</label>
                    <div className='relative w-full'>
                        <input
                            type='file'
                            id='swap'
                ...
                <div className='relative w-full lg:w-[80%] mb-6'>
                    <label htmlFor="desc" className="text-[#D8BA78] font-bold text-2xl mb-2 block">Description Garment/Baju</label>
                    <div className='relative w-full'>
                        <input
                            type='text'
                            id='desc'
                            name='desc'
                            className={`w-full border-2 border-[#D8BA78] rounded-sm font-semibold text-2xl outline-none py-2 px-3 text-white bg-black bg-opacity-[4%]'`}
                ...
                <div className='relative w-full lg:w-[80%] mb-6'>
                    <label htmlFor="seed" className="text-[#D8BA78] font-bold text-2xl mb-2 block">Seed</label>
                    <div className='relative w-full'>
                        <input
                            type='number'
                            id='seed'
                ...
                <div className='relative w-full lg:w-[80%] mb-6'>
                    <label htmlFor="step" className="text-[#D8BA78] font-bold text-2xl mb-2 block">Steps</label>
                    <div className='relative w-full'>
                        <input
                            type='number'
                            id='step'
                ...
                <div className='relative w-full lg:w-[80%] mb-6'>
                    ...
                    <div><Image src={imageFaceSwap.url} width={768} height={1024} className='w-full' alt='zirolu'></Image></div>
                </div>
                }
            </div>
