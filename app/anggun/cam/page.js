    ...
    return (
        <main className="flex fixed h-full w-full bg-anggun overflow-auto flex-col justify-center items-center py-16 px-20" onContextMenu={(e)=> e.preventDefault()}>
            <div className='fixed top-24 w-[55%]'>
                <Image src='/anggun/title-take.png' width={823} height={221} alt='Zirolu' className='w-full' priority />
            </div>
            ...
            {!enabled && 
                <div className={`fixed left-0 bottom-20 w-full flex justify-center items-center flex-col ${capturedAwal ? 'hidden' : ''}`}>
                    <button className="relative mx-auto flex w-[60%] justify-center items-center" onClick={captureVideo}>
                        <Image src='/anggun/btn-capture.png' width={830} height={192} alt='Zirolu' className='w-full' priority />
                    </button>
                    <Link href='/anggun' className="relative w-[70%] mx-auto flex justify-center items-center">
            ...
            <div className={`fixed left-0 bottom-14 w-full ${!enabled ? 'hidden' : ''}`}>
                <div className="relative w-[60%] mx-auto flex justify-center items-center flex-col">
                    <Link href='/anggun/generate' className="w-full relative mx-auto flex justify-center items-center" onClick={generate}>
                        <Image src='/anggun/btn-continue.png' width={830} height={192} alt='Zirolu' className='w-full' priority />
                    </Link>
                    <button className="relative w-full mx-auto flex justify-center items-center pt-10" onClick={retake}>
                        <Image src='/anggun/btn-retake.png' width={830} height={192} alt='Zirolu' className='w-full' priority />
                    </button>
                </div>
            </div>
        </main>
