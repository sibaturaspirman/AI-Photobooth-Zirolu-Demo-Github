    ...
    return (
        <main className="flex fixed h-full w-full bg-anggun overflow-auto flex-col justify-center items-center py-16 px-20" onContextMenu={(e)=> e.preventDefault()}>
                ...
                <div className='absolute top-0 left-0 right-0 bottom-0 flex items-center justify-center flex-col'>
                    <div className='relative w-[60%] overflow-hidden'>
                        <div className='relative w-full'>
                            <Image src='/anggun/title-front.png' width={773} height={158} alt='Zirolu' className='w-full' priority />
                        </div>
                    </div>
            ...
            <div className={`fixed top-24 w-[60%] ${numProses1 ? 'opacity-0 pointer-events-none' : ''}`}>
                <Image src='/anggun/title-select.png' width={686} height={112} alt='Zirolu' className='w-full' priority />
            </div>
                ...
                <div className={`fixed left-0 bottom-14 w-full`}>
                    <div className="relative w-[80%] mx-auto flex justify-center items-center flex-col">
                        <button className={`w-full relative mx-auto flex justify-center items-center ${!styleGender ? 'hidden' : ''}`} onClick={generateAI}>
                            <Image src='/anggun/btn-suprise.png' width={830} height={192} alt='Zirolu' className='w-full' priority />
                        </button>
                        <Link href='/anggun' className="relative w-full mx-auto flex justify-center items-center">
