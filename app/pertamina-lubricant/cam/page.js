...
export default function Cam() {
    ...
    useEffect(() => {
        ...
        const aiInstance = new PadmaAIClient("https://padmaai.zirolu.id", "app_tXxTmRGXzUwliMw1sMgdFUlDFF2S2IO6", "fc08754a-4b5c-4c6c-b2a3-3b5d8a0318a9");
        ...
        padmaAI.onProgress((progress) => {
          ...
          try {
            ...
            .then(dataUrl => {
                ...
                setTimeout(() => {
                    router.push('/pertamina-lubricant/result');
                }, 200);
            })
    ...
    return (
        <main className="flex fixed h-full w-full bg-meta overflow-auto flex-col items-center justify-center pt-2 pb-5 px-5 lg:pt-12 lg:px-20" onContextMenu={(e)=> e.preventDefault()}>
            ...
            <div className={`relative w-[90%]`}>
                <div className='animate-upDownCepet relative py-5 px-6 mt-5 lg:text-6xl border-2 text-center bg-[#123D77] rounded-xl text-[#fff] font-bold'>
