...
export default function Register() {
    ...
    const generateAI = () => {
        ...
        setTimeout(() => {
            router.push('/pertamina-lubricant/cam');
        }, 100);
    }
    ...
    return (
        <main className="flex fixed h-full w-full bg-meta overflow-auto flex-col items-center justify-center pt-2 pb-5 px-5 lg:pt-12 lg:px-20" onContextMenu={(e)=> e.preventDefault()}>
            ...
            {/* PILIH STYLE */}
            <div className={`relative w-[90%] mx-auto lg:mt-10`}>
                ...
                {/* {character && */}
                    <div className={`relative w-full flex justify-center items-center lg:mt-[9rem] z-20 ${character ? `` : 'opacity-0 pointer-events-none'}`}>
                        <button className="relative mx-auto w-[100%] flex justify-center items-center" onClick={generateAI}>
                            <Image src='/jelajahputri/btn-continue.png' width={850} height={258} alt='Zirolu' className='w-full' priority />
                        </button>
                    </div>
                {/* } */}
            </div>
