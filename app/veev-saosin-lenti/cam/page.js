...
export default function Cam() {
    ...
    useEffect(() => {
        ...
        const aiInstance = new PadmaAIClient("https://padmaai.zirolu.id", "app_tXxTmRGXzUwliMw1sMgdFUlDFF2S2IO6", "54a107ca-4760-435c-a771-55f7c301a7b9");
        ...
        padmaAI.onProgress((progress) => {
          ...
          try {
            ...
            .then(dataUrl => {
                ...
                setTimeout(() => {
                    router.push('/veev-saosin-lenti/result');
                }, 200);
            })
            ...
            {!enabled && 
                <div className={`relative w-full flex justify-center items-center mt-8 ${capturedAwal ? 'opacity-0 pointer-events-none' : ''}`}>
                    <button className="relative mx-auto flex  w-[80%] justify-center items-center" onClick={captureVideo}>
                        <Image src='/comcon/veev/btn-capture.png' width={864} height={210} alt='Zirolu' className='w-full' priority />
                    </button>
                </div>
            }
            ...
            <div className={`relative w-full ${!enabled ? 'hidden' : ''}`}>
                <div className="relative w-[80%] mx-auto flex justify-center items-center flex-col mt-0">
                    <button className="w-full relative mx-auto flex justify-center items-center" onClick={generateAI}>
                        <Image src='/comcon/veev/btn-surprise.png' width={864} height={210} alt='Zirolu' className='w-full' priority />
                    </button>
