...
export default function Result() {
    ...
    return (
        <main className="flex fixed h-full w-full bg-veev-lenti overflow-auto flex-col items-center justify-center pt-2 pb-5 px-5 lg:pt-12 lg:px-20" onContextMenu={(e)=> e.preventDefault()}>
        <div className="fixed top-0 left-0 w-full h-full bg-iqos-border pointer-events-none z-50 hidden lg:block"></div>
            <div className={`relative w-[10%] lg:w-[50%] mx-auto mt-0 mb-2 lg:mb-10 ${generateQR ? `opacity-0 pointer-events-none` : ''}`}>
                <Image src='/veev/lenti/aura.png' width={650} height={104} alt='Zirolu' className='w-full' priority />
            </div>
            {/* QR */}
            {generateQR && 
                <div className='absolute top-[2rem] left-0 right-0 bottom-0 flex items-center justify-center flex-col z-40 bg-black bg-opacity-0'>
                    ...
                    <Link href='/veev-saosin-lenti' className="relative w-[60%] mx-auto flex justify-center items-center">
            ...
            <div className={generateQR ? `opacity-0 pointer-events-none` : 'relative w-full flex justify-center items-center flex-col'}>
                ...
                <div className={`relative w-full ${loadingDownload ? 'hidden' : ''}`}>
                    ...
                    <div className={`w-[70%] mx-auto lg:w-full`} onClick={downloadImageAI}>
                        <div className={`w-full lg:mt-10`}>
                            <div className="relative w-[80%] mx-auto flex justify-center items-center flex-col">
                                <div className="w-full relative mx-auto flex justify-center items-center">
                                 <Image src='/comcon/veev/btn-collect.png' width={864} height={210} alt='Zirolu' className='w-full' priority />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='w-[40%] mx-auto lg:w-full'>
                        <div className="relative w-[80%] mx-auto flex justify-center items-center flex-col">
                            <Link href='/veev-saosin-lenti' className="relative w-full mx-auto flex justify-center items-center">
