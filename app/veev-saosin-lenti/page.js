...
export default function IQOSHome() {
  return (
    <div className="flex fixed h-full w-full bg-veev-lenti overflow-auto flex-col items-center justify-center">
      ...
      <div className="absolute mx-auto bottom-10 lg:bottom-[20rem] w-[80%] ">
        <Link href='/veev-saosin-lenti/style' className='relative w-full mx-auto flex justify-center items-center'>
