...
export default function VoiceWaveMagnum({ direct }) {
  ...
  }, [countdownStart, maxDuration]);

  return (
    <div className="relative top-0 left-0 mt-5 lg:mt-20 w-full h-full">
<div className="relative w-full">
        <ReactPlayer url={['/greenday/scream.mp4']}  playing={playVideo} loop width={555} height={1174} />
        </div>
