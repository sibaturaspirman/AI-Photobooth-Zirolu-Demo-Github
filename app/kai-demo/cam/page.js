...
export default function Cam() {
    ...
    return (
        <main className="flex fixed h-full w-full bg-kai overflow-auto flex-col items-center pt-8 pb-5 px-5 lg:pt-12 lg:px-20">
            ...
            <h1 className={`text-center text-xl font-bold mt-1 lg:mt-0 lg:text-5xl mb-2 lg:mb-5 ${poppins.className}`}>SAY &#34;CHEESEE&#34;</h1>
            ...
            <div className={`relative w-full ${!enabled ? 'hidden' : ''}`}>
                <div className="relative w-[70%] mx-auto flex justify-center items-center flex-col mt-0 mt-5 lg:mt-5">
                    <Link href='/kai-demo/generate' className="block w-full relative mx-auto flex justify-center items-center">
