...
export default function Cam() {
    ...
    useEffect(() => {
        ...
        const aiInstance = new PadmaAIClient("https://padmaai.zirolu.id", "app_tXxTmRGXzUwliMw1sMgdFUlDFF2S2IO6", "5bca5304-d746-47a0-bb5a-5155936da3c7");
        ...
        padmaAI.onProgress((progress) => {
          ...
          try {
            ...
            .then(dataUrl => {
                ...
                setTimeout(() => {
                    router.push('/greenday/veev/result');
                }, 200);
            })
