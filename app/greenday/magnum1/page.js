...
export default function GreendayMagnumHome() {
  return (
    <Link href='/greenday/magnum1/cam' className="flex fixed h-full w-full overflow-auto flex-col items-center justify-center pt-2 pb-5 px-5 lg:pt-0 lg:px-20 mt-0">
